...
public class ExchangeRateController {
    ...
    @RequestMapping(path = "/exchangeRates/latest", method = RequestMethod.GET)
    ...
    @RequestMapping(path = "/exchangeRates/{date}", method = RequestMethod.GET)
    ...
    @RequestMapping(path = "/exchangeRates", method = RequestMethod.GET)
